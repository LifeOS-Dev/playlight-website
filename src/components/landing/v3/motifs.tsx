...
const FLAT =
  "M12 78 20 74 28 82 36 72 44 80 52 75 60 83 68 71 76 79 84 74 92 82 100 73 108 81 116 76 124 84 132 72 140 80 148 75 156 83 164 74 172 79 180 77 188 82 196 73 204 80 212 76 220 79 228 78";
...
function MemorySolution() {
  return (
    <Plate>
      ...
      <path {...line} strokeWidth={1.2} d="M88 104c30 0 20-46 44-52" strokeDasharray="2.5 4" />
